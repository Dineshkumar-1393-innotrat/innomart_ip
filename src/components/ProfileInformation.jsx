...
//   // 1) USER TYPE COMES FROM LOGIN/SIGNUP (context or route state)
//   //    Assume you set it when user signs up/logs in.
//   const initialUserType =
//     location.state?.userType || state.userData?.userType || "startup";
//   const [userType] = useState(initialUserType); // no setter -> cannot change here
...
//     const base = initialData || state.userData || {};
...
//     setImageInput({
//       source: base.profileImageSource || "upload",
//       url: base.profileImage || "",
//     });
...
//   const handleFocusAreaKeyDown = (e) => {
//     if (e.key === "Enter") {
//       e.preventDefault();
//       handleFocusAreaAdd();
//     }
...
//   // ---------- AUTO‑FILL LOGIN FIELDS BASED ON TYPE ----------
//   useEffect(() => {
//     // assume login/signup stored these fields in state.userData
//     const savedLogin = state.userData || {};

//     if (userType === "startup") {
//       setFormData((prev) => ({
//         ...prev,
//         companyName: savedLogin.companyName || prev.companyName || "",
//         primaryPerson: savedLogin.primaryPerson || prev.primaryPerson || "",
//         email: savedLogin.email || prev.email || "",
//         username: savedLogin.username || prev.username || "",
//         password: "", // do not prefill password in UI
//       }));
//     } else if (userType === "innovator") {
//       setFormData((prev) => ({
//         ...prev,
//         name: savedLogin.name || prev.name || "",
//         email: savedLogin.email || prev.email || "",
//         username: savedLogin.username || prev.username || "",
//         password: "",
//         portfolioLink: savedLogin.portfolioLink || prev.portfolioLink || "",
//       }));
//     } else if (userType === "institution") {
//       setFormData((prev) => ({
//         ...prev,
//         institutionName:
//           savedLogin.institutionName || prev.institutionName || "",
//         email: savedLogin.email || prev.email || "",
//         username: savedLogin.username || prev.username || "",
//         password: "",
//       }));
//     }
//   }, [userType, state.userData]);
...
//                       type="button"
//                       onClick={() =>
//                         setImageInput({ source: "upload", url: "" })
//                       }
//                       className="flex items-center gap-2 text-xs font-semibold text-red-500 hover:text-red-600"
//                     >
//                       <UploadCloud className="h-4 w-4" />
...
//               <form onSubmit={handleSave} className="space-y-10">
//                 {/* BASIC / LOGIN BLOCK (dynamic) */}
//                 <div className="space-y-6">
//                   <div className="flex items-center gap-2 text-blue-600 font-semibold">
//                     <UserRound className="w-5 h-5" />
//                     <h2 className="text-lg text-gray-800">
//                       {userType === "startup"
//                         ? "Startup Login Details"
//                         : userType === "innovator"
//                         ? "Innovator Login Details"
...
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                     {renderLoginFields()}
//                     {renderCommonLoginFields()}
//                   </div>
//                 </div>

//                 {/* keep your other sections (address, professional info, focus areas, links) below here */}
